...
public class ServicioProductoImpl implements ServicioProducto{
    ...
    public Producto registrarProducto(DatosRegistroProducto producto, Usuario usuario) throws Exception {
        ...
        String nombreConRuta = "imgProductos/" + producto.getImgproducto().getOriginalFilename();
        nuevoProducto.setImgproducto(nombreConRuta);

        String filename = "C:\\Taller WEB\\TPTallerWeb\\src\\main\\webapp\\imgProductos\\" + producto.getImgproducto().getOriginalFilename();
